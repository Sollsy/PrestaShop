 ...
 *}
 <tr id="product_rule_group_{$product_rule_group_id|intval}_tr" style="margin-bottom:1rem;">
	<td class="panel condition_group alert-info">
		<h3><i class="icon-tasks"></i> {l s='Condition group' d='Admin.Catalog.Feature'} {$product_rule_group_id|intval}</h3>
